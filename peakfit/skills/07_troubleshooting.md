...
2. Add paths manually when calling directly:
   ...
   sys.path.insert(0, "/path/to/standalone_peakfit/src")
   sys.path.insert(0, "/path/to/standalone_peakfit/fitters")
   sys.path.insert(0, "/path/to/standalone_peakfit/smx_ana")
   ```
